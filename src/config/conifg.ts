...
export const TXT_NEWS = '<span style="color:white">Welcome to ' + GAME_TITLE + '!</span>'
										// news message displayed at top of all pages
										// undefine if you don't want any
export const TXT_RULES = 'Additional information can be found in our forums.<br />'	// extra rules to display on signup page
	+ 'Please read through the FAQs before contacting an Administrator.'	// undefine if you don't want any
export const TXT_EMAIL = 'Be sure to check out http://www.qmtpro.com/ and tell your friends about us!'
...
export const PVTM_SHOPBONUS = 0.20	// Percentage of private market cost bonus for which shops are responsible (0-1)
