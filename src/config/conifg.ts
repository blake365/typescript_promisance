...
export const ROUND_START = new Date('2023-11-02T08:00:00') // Date and time of round start
export const ROUND_END = new Date('2023-11-21T12:00:00') // Date and time of round end
